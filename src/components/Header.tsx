...
const Header = () => {
	...
	return (
		<header className="absolute top-0 left-0 w-full bg-gradient-to-r from-purple-600 to-blue-600 shadow-lg">
				...
				{isMenuOpen && (
					<div>
						<div className="px-2 pt-2 pb-3 space-y-1 bg-purple-700 rounded-lg mb-4">
							<Link
								href="/games"
								className="block px-3 py-2 text-white hover:bg-purple-600 rounded-md transition-colors duration-200"
